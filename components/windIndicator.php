<div class="w-3xs border-3 rounded-lg border-sky-400 px-4 py-2 mt-8">
    <div class="flex items-center gap-2">
        ...
        <h3>
            <span class="text-sky-300 text-lg  font-bold">Wind force</span>
        </h3>
    </div>
    <div class="flex gap-2 items-center justify-center mt-4 ">
        <div class="flex gap-1">
            <?php for ($i = 0; $i < 3; $i++) { ?>
                <div class="w-4 h-5 bg-sky-300 rounded-xs"></div>
        ...
        <div class="flex gap-1">
            <?php for ($i = 0; $i < 3; $i++) { ?>
                <div class="w-4 h-5 bg-zinc-300/50 rounded-xs"></div>
            <?php } ?>
        </div>
    </div>
</div>